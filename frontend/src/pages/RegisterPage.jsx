    ...
    return (
        <div className="min-h-screen grid lg:grid-cols-2">
            ...
            <div className="hidden lg:block relative bg-[#09090b]">
                <img
                    src="https://images.unsplash.com/photo-1544640805-3536bc48cb73?q=80&w=2070&auto=format&fit=crop"
                ...
                <div className="absolute bottom-16 left-16 max-w-lg">
                    <h2 className="text-5xl font-black text-white italic tracking-tighter mb-6 uppercase">"Build your legacy within our pages."</h2>
            ...
            <div className="flex items-center justify-center p-8 bg-[#09090b]">
                <div className="w-full max-w-md space-y-12 stagger-item">
                    <div className="text-center lg:text-left">
                        ...
                        <h1 className="text-5xl font-black text-white italic uppercase tracking-tighter mb-2">Join the Circle.</h1>
                        <p className="text-slate-500 uppercase tracking-widest text-[10px] font-bold">New Contributor Registration</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        >
                            {loading ? 'Creating Account...' : 'Become a Contributor'}
                        </button>
                    </form>

                    <p className="text-center text-slate-600 text-xs font-bold uppercase tracking-widest">
                        Already registered? <Link to="/login" className="text-white hover:text-indigo-400 transition-colors">Sign in here</Link>
                    </p>
                </div>
            </div>
        </div>
